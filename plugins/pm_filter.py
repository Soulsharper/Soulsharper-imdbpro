...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_sticker(chat_id=message.from_user.id, sticker='CAADBQADNgMAAhfQ2FdPgWCz2yTrAAEC')
            return
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='https://t.me/numberonemovieworld'),
                ]
                ]
            await query.message.edit(text="<b>Developer : <a href='https://t.me/SoulSharper'>SoulSharper</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nHappiness : <a href='https://t.me/Happy_Or_Sed'>Happy Or Sad ?</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                     InlineKeyboardButton('Movie Group', url='https://t.me/moviezsworlds'),
                    ]
                    ]
